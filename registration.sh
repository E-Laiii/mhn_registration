...
uuid=$(python3 -c 'import json;obj=json.load(open("/tmp/deploy.json"));print (obj["uuid"])')
...
export HPF_IDENT=$(python3 -c 'import json;obj=json.load(open("/tmp/deploy.json"));print (obj["identifier"])')
export HPF_SECRET=$(python3 -c 'import json;obj=json.load(open("/tmp/deploy.json"));print (obj["secret"])')
######################################################
